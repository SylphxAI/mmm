...
Validate Codec's project-control and GroundAtlas adoption surfaces without changing codec package behavior, media-format implementations, WASM behavior, or downstream product workflows.
...
It does not own application-specific media workflows, media storage/CDN behavior, UI products, external codec licensing, or shared organization rulesets.
